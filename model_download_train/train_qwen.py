...
DATA_FILE = "trainingdata2.jsonl"
dataset = load_dataset("json", data_files=DATA_FILE, split="train")

# Load tokenizer
MODEL_PATH = "/home/xinyiade/InstaAIModel/Qwen2.5-1.5B"
...
training_args = TrainingArguments(
    output_dir="/home/johnkimm/InstaAIModel/qwen2.5_finetuned",
...
checkpoint_dir = "/home/johnkimm/InstaAIModel/qwen2.5_finetuned"
...
model.save_pretrained("/home/johnkimm/InstaAIModel/qwen2.5_finetuned")
tokenizer.save_pretrained("/home/johnkimm/InstaAIModel/qwen2.5_finetuned")
print("Training complete! Model saved in '/home/johnkimm/InstaAIModel/qwen2.5_finetuned'.")
